...
/*
** A list of contacts implemented as a hash table
*/
  ...
  */
  while(1) {
    ...
    */
    ...
    /*
    ** Keyword: count
    ** Action: display how many contacts are in each 
    **         hash bucket
    */
    if( !strncmp(action,"count",5) ) {
      count();
    }

    /*
    ** Keyword: delete
    ** Action: delete a contact given a family name and a given name
    */
    ...
    /*
    ** Keyword: find
    ** Action: find a contact given a family name and a given name
    */
    ...
    */
    if( !strncmp(action,"help",4) ) {
      printf("Actions available: quit, add, list, delete, find, load, count\n");
    }
